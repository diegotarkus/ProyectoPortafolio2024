...
class Orden (models.Model):
    ...
    cupon = models.ManyToManyField(Cupon, verbose_name="cupon", blank=True, default=False)
    descuento = models.IntegerField(default=0, validators=[MinValueValidator(0), MaxValueValidator(100)], blank=True)
